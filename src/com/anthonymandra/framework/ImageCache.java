...
public class ImageCache
{
	...
	public static class ImageCacheParams
	{
		...
		/**
		 * Sets the memory cache size based on a percentage of the device memory class. Eg. setting percent to 0.2 would set the memory cache to one
		 * fifth of the device memory class. Throws {@link IllegalArgumentException} if percent is < 0.05 or > .8.
		 * 
