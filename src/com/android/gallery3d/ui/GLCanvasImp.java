...
public class GLCanvasImp implements GLCanvas
{
	...
	private void drawBoundTexture(BasicTexture texture, int x, int y, int width, int height) throws DeadBitmapException
	{
	...
	private void convertCoordinate(RectF source, RectF target, BasicTexture texture) throws DeadBitmapException
	{
	...
	private void drawMixed(BasicTexture from, BasicTexture to, float ratio, int x, int y, int width, int height, float alpha) throws DeadBitmapException
	{
