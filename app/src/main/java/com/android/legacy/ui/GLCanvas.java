...
public interface GLCanvas
{
	...
	void drawTexture(BasicTexture texture, int x, int y, int width, int height) throws
            DeadBitmapException;

	void drawMesh(BasicTexture tex, int x, int y, int xyBuffer, int uvBuffer,
	...
	void drawTexture(BasicTexture texture, int x, int y, int width, int height, float alpha) throws
            DeadBitmapException;

	// Draws a the source rectangle part of the texture to the target rectangle.
	void drawTexture(BasicTexture texture, RectF source, RectF target) throws
            DeadBitmapException;

	// Draw two textures to the specified rectange. The actual texture used is
	// from * (1 - ratio) + to * ratio
	// The two textures must have the same size.
	void drawMixed(BasicTexture from, BasicTexture to, float ratio, int x, int y, int w,
