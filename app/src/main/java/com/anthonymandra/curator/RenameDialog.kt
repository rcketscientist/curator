...
import com.anthonymandra.curator.databinding.FormatNameBinding
...
class RenameDialog(
	...
	private lateinit var ui: FormatNameBinding
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		ui.nameTextView.addTextChangedListener(object : TextWatcher {
		...
		ui.formatSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
			@SuppressLint("SetTextI18n")
		...
		ui.renameButton.setOnClickListener {
			val customName = ui.nameTextView.text.toString()
			val selected = ui.formatSpinner.selectedItemPosition
			renameImages(itemsToRename, selected, customName)
			dismiss()
		}

		ui.cancelButton.setOnClickListener { dismiss() }
	}
...
//							Crashlytics.logException(it)
	...
	private fun updateExample() {
		ui.exampleTextView.text = "Ex: " + formatRename(
			ui.formatSpinner.selectedItemPosition,
			ui.nameTextView.text.toString(),
