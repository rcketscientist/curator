...
//            setValidityTimestamp(String.valueOf(System.currentTimeMillis() + (MILLIS_PER_MINUTE * 60 *24*30)));	//AJM: Enforce 30 day grace
            setValidityTimestamp(String.valueOf(Long.MAX_VALUE));	//AJM: Just license indefinitely after a successful check
