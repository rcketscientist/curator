...
// AJM: MOved to its own class 'PhotoModel'
...
//                            Uri contentUri = mCurrentPhoto.getUri();//getContentUri();
...
//        }
        ...
        mPhotoView.setFilmMode(mStartInFilmstrip && mVisibleItems.size() > 1);
...
//                .addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
    ...
    //TODO: Not sure what "tiny planet" is
...
//        }
    ...
    // AJM: I don't see the point of this
...
//                data.putString(SlideshowPage.KEY_SET_PATH, mMediaSet.getFilePath().toString());
...
//    @Override
    public void onDeleteImage(Uri path, int offset) {
